...
use routes::{AboutPage, AuthPage, CartPage, ContactUsPage, HomePage, NotFound, SearchPage};
...
pub fn shell(options: LeptosOptions) -> impl IntoView {
    view! {
        <!DOCTYPE html>
        <html lang="en" class="overflow-x-hidden" class:dark={THEME == "dark"}>
            <head>
                <meta />
                <meta charset="utf-8" />
            ...
            <body class="flex flex-col gap-6 mx-6 bg-white md:mx-36 dark:bg-black">
                <App />
            </body>
        </html>
    }
